...
//  多重bmo宇宙
//
//  Created by Hydee Chen on 2023/6/30.
//
...
class ViewController: UIViewController {
    ...
    func addBody() -> CAShapeLayer {
        ...
        bodyLayer.fillColor = UIColor(red: CGFloat.random(in: 0...255)/255, green: CGFloat.random(in: 0...255)/255, blue: CGFloat.random(in: 0...255)/255, alpha: 1).cgColor
    ...
    func addBackBody() -> CAShapeLayer {
        ...
        backBodyLayer.fillColor = UIColor(red: CGFloat.random(in: 0...255)/255, green: CGFloat.random(in: 0...255)/255, blue: CGFloat.random(in: 0...255)/255, alpha: 1).cgColor
    ...
    //設定隨機設定位置和隨機顏色功能
    func addBMOView(){
        let oneDegree = CGFloat.random(in: -180...180) / 180
            let drawView = makeUIView()
            
            // 設定隨機大小位置
            let randomSize = CGFloat.random(in: 0.2...1)
            let randomMoveX = CGFloat.random(in: -6...300)
            let randomMoveY = CGFloat.random(in: -6...500)
            
            let transform = CGAffineTransform(translationX: randomMoveX, y: randomMoveY).scaledBy(x: randomSize, y: randomSize)
            drawView.transform = transform.rotated(by: oneDegree)
    ...
    override func viewDidLoad() {
        ...
        for _ in 1...Int.random(in: 50...100){
            addBMOView()
        }
